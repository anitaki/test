            ...
            <div class="filter-inputs">
                ...
                <div class="filter-group">
                    ...
                    <select name="category">
                        ...
                        <?php
                        // Παίρνουμε τις κατηγορίες στην τρέχουσα γλώσσα
        ...
        <div id="event_filter_results">
            ...
            if($default_query->have_posts()){
                ...
                if($default_query->max_num_pages > 1) {
                    ...
                    echo '<button class="load-more-events filter-submit" data-page="2" data-start="" data-end="">';
